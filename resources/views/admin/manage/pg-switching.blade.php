...
@section('title','PG Switching Report')
@section('page-title','PG Switching Report')
...
<div class="sw-head">
    <div>
        <div class="sw-title">PG Switching Report</div>
        <div class="sw-crumb"><span>⌂ Dashboard</span><span>»</span><span>Manage</span><span>»</span><strong style="color:var(--text-primary)">PG Switching Report</strong></div>
    </div>
...
function fmtAmt(n){const v=Number(n||0);return v>=100000?'₹'+( v/100000).toFixed(2)+'L':v>=1000?'₹'+(v/1000).toFixed(2)+'K':'₹'+v.toFixed(2)}
